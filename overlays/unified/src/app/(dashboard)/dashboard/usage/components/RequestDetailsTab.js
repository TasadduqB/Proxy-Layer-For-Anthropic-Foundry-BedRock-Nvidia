...
function getTotalInputTokens(tokens) {
  const prompt = tokens?.prompt_tokens || tokens?.input_tokens || 0;
  const cachedPortion = getCachedTokens(tokens) + getCacheCreationTokens(tokens);
  return prompt >= cachedPortion ? prompt : prompt + cachedPortion;
}

function getFreshInputTokens(tokens) {
  return Math.max(0, getTotalInputTokens(tokens) - getCachedTokens(tokens) - getCacheCreationTokens(tokens));
}
          ...
          <table className="w-full min-w-[980px]">
            <thead>
              <tr className="border-b border-black/5 dark:border-white/5">
                ...
                <th className="text-right p-4 text-sm font-semibold text-text-main">Fresh Input</th>
                ...
                <th className="text-right p-4 text-sm font-semibold text-text-main">Total Input</th>
                ...
                details.map((detail, index) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-sm text-text-main text-right font-mono">
                      {getFreshInputTokens(detail.tokens).toLocaleString()}
                    </td>
                    <td className="p-4 text-sm text-text-main text-right font-mono">
                    ...
                    <td className="p-4 text-sm text-text-main text-right font-mono">
                      {getTotalInputTokens(detail.tokens).toLocaleString()}
                    </td>
                    <td className="p-4 text-sm text-text-main text-right font-mono">
          ...
          <div className="space-y-6">
            <div className="grid min-w-0 grid-cols-1 gap-4 text-sm sm:grid-cols-2">
              ...
              <div>
                ...
                <span className="text-text-main font-mono">
                  {getFreshInputTokens(selectedDetail.tokens).toLocaleString()}
                </span>
              </div>
              ...
              <div>
                ...
                <span className="text-text-main font-mono">
                  {getTotalInputTokens(selectedDetail.tokens).toLocaleString()}
                </span>
              </div>
              <div>
