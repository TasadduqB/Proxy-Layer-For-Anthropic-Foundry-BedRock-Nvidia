...
// Build TOML config for Proxy Max (openai provider mode)
const buildProxyMaxConfig = (baseUrl, apiKey, model) => {
...
// Detect Proxy Max by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildProxyMaxConfig(baseUrl, apiKey || "sk_proxy-max", model);
