...
const SAFE_PSD_FIELDS = [
  "baseUrl", "azureEndpoint", "deployment", "apiVersion", "apiType",
  "endpointMode", "authMode", "organization", "accountId", "endpoint",
  ...
  if (c.providerSpecificData) {
    ...
    for (const f of SAFE_PSD_FIELDS) {
      if (c.providerSpecificData[f] !== undefined) {
        psd[f] = redactCredentialObject(c.providerSpecificData[f], f);
      }
    }
