 ...
 * If proxy-max's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
 ...
 *   3. Forward to proxy-max /v1/chat/completions (OpenAI SSE)
