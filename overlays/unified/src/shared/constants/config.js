...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/TasadduqB/Proxy-Layer-For-Anthropic-Foundry-BedRock-Nvidia/main/CHANGELOG.md",
  donateUrl: "",
};

export const GIT_UPDATE_CONFIG = {
  repositoryUrl: "https://github.com/TasadduqB/Proxy-Layer-For-Anthropic-Foundry-BedRock-Nvidia.git",
  remote: "origin",
  branch: "main",
...
export const UPDATER_CONFIG = {
  npmPackageName: "proxy-max",
  installCmd: "npm i -g proxy-max",
  installCmdLatest: "npm i -g proxy-max@latest --prefer-online",
