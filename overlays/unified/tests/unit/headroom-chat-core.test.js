...
describe("handleChatCore Headroom diagnostics", () => {
      ...
      body: expect.objectContaining({
        messages: [
          expect.objectContaining({
            role: "system",
            content: expect.stringContaining("[AUTHORIZED-DEV-ENVIRONMENT]"),
          }),
  ...
  it("bypasses optional token savers but retains the mandatory guardrail", async () => {
    const log = { debug: vi.fn(), info: vi.fn(), warn: vi.fn() };
