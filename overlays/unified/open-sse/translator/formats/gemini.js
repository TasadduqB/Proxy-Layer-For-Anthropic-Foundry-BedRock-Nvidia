...
import { documentToGeminiPart, normalizeOpenAIFile } from "../concerns/document.js";
...
export function convertOpenAIContentToParts(content) {
  ...
  if (typeof content === "string") {
    ...
    for (const item of content) {
      ...
      } else if (item.type === OPENAI_BLOCK.FILE && item.file) {
        const documentPart = documentToGeminiPart(normalizeOpenAIFile(item.file));
