 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what proxy-max needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a proxy-max
...
/**
 * Detect whether a model id refers to a proxy-max synthetic agentic variant.
...
/**
 * Detect whether a model id is a proxy-max synthetic thinking variant
...
/**
 * Resolve a proxy-max model id to the real upstream Kiro model id, plus flags
