export default {
  ...
  transport: {
    ...
    // NVIDIA catalog entries can be account/region-specific. Do not spend
    // minutes retrying one unreachable model; the Claude combo owns fallback
    // and immediately advances to another NVIDIA model.
    timeoutMs: 12_000,
    retry: {
