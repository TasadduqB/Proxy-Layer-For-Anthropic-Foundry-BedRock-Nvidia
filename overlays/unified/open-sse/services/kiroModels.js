 ...
 * into proxy-max-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are proxy-max fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic proxy-max variant set for a single upstream Kiro model.
 *
 ...
 * into proxy-max variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
