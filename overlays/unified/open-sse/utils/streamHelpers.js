...
export function parseSSELine(line, format = null) {
  ...
  // NDJSON providers send raw JSON without a data: prefix. Auto-detecting a
  // syntactically JSON-shaped line is safe and covers OpenAI-compatible nodes
  // that omit their Ollama format hint.
  if (format === FORMATS.OLLAMA || trimmed.startsWith("{") || trimmed.startsWith("[")) {
