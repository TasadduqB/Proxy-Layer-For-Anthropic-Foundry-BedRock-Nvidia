...
console.log("📦 Building Proxy Max CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/proxy-max/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.proxy-max/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.proxy-max/runtime)");
}
console.log("");
